...
use DB;
class SelectedDosManagerExport implements
    FromCollection,
    WithHeadings,
    ShouldAutoSize,
    WithMapping
{
    ...
    public function collection()
    {
        ...
        $query =
            "SELECT u.*, s.name AS storeName FROM users u, store_cities sc, store s WHERE u.user_type = 'manager' AND u.store_id = s.id AND s.city_id = sc.id AND u.deleted_at is NULL AND u.id in (" .
            $whereIn .
            ")";
